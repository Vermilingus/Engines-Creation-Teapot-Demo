...
int main(int argc, char* args[])
{
	...
	if(InitSDL())
	{
		...
		gameScreenManager = new GameScreenManager(SCREEN_INTRO, gameScreenManager, gBounce, gScream, gVictory);
...
{	
	...
	else
	{
		...
		gScream = Mix_LoadWAV("Scream.wav");
		gVictory = Mix_LoadWAV("Victory.wav");
	}
